...
A startpage that focuses on minimalism and functionality.
...
If you want this on the new tab page (Firefox).
...
Add the changeWallpaper file to path and preferably bind the script to a key.
...
I have de-bloated it and tried to make it minimal
